...
public class UserDao {
	...
	public void outCredits(String out, int credits) {
		String sql = "update t_user set credits = credits - ? where user_name = ?";
		jdbcTemplate.update(sql,credits,out);
	}
	
	public void inCredits(String in, int credits) {
		String sql = "update t_user set credits = credits + ? where user_name = ?";
		jdbcTemplate.update(sql,credits,in);
	}
}
